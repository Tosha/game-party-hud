...
public class BarSmootherTests
{
    [Fact]
    public void FirstSample_ReturnsRaw()
    {
        var s = new BarSmoother();
    ...
    {
        var s = new BarSmoother(windowSize: 1);
    ...
    {
        Assert.Throws<System.ArgumentOutOfRangeException>(() => new BarSmoother(windowSize: 0));
        Assert.Throws<System.ArgumentOutOfRangeException>(() => new BarSmoother(windowSize: -1));
    }
}
